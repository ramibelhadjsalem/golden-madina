...
const AdminDashboard = () => {
  ...
  const recentActivity = [
    {
      id: 1,
      action: t('newBookingRequest'),
      description: t('tourBooking'),
    ...
    {
      id: 2,
      action: t('blogPostPublished'),
      description: t('conservationTechniques'),
      time: "2 " + t('hoursAgo'),
      icon: (
    ...
    {
      id: 3,
      action: t('newArtifactAdded'),
      description: t('romanCoin'),
      time: "1 " + t('daysAgo'),
      icon: (
              ...
              <Link to="/admin/blogs/new" className="group">
                <div className="border rounded-lg p-4 hover:bg-slate-50 transition-colors">
                  <div className="flex flex-col items-center text-center gap-2">
                    ...
                    <span className="font-medium">{t('newBlogPost')}</span>
                  </div>
                </div>
              </Link>
              <Link to="/admin/artifacts/new" className="group">
                <div className="border rounded-lg p-4 hover:bg-slate-50 transition-colors">
                  <div className="flex flex-col items-center text-center gap-2">
                    ...
                    <span className="font-medium">{t('addArtifact')}</span>
                  </div>
                </div>
              </Link>
              <Link to="/admin/services/new" className="group">
                <div className="border rounded-lg p-4 hover:bg-slate-50 transition-colors">
                  <div className="flex flex-col items-center text-center gap-2">
                    ...
                    <span className="font-medium">{t('createService')}</span>
                  </div>
                </div>
              </Link>
              <Link to="/admin/bookings" className="group">
                <div className="border rounded-lg p-4 hover:bg-slate-50 transition-colors">
                  <div className="flex flex-col items-center text-center gap-2">
                    ...
                    <span className="font-medium">{t('manageBookings')}</span>
                  </div>
                </div>
              </Link>
            </div>
