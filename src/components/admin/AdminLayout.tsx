    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="lg:hidden flex items-center justify-between p-4 bg-slate-900 text-white">
        <div className="flex items-center gap-2">
          ...
          <div className="font-serif text-xl">Heritage Admin</div>
        </div>
      </div>
      ...
      {/* Sidebar */}
      <aside 
        className={`fixed top-0 left-0 z-30 h-full w-64 bg-slate-900 text-white transform transition-transform duration-200 ease-in-out ${
